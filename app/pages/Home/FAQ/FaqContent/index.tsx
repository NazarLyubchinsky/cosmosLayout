		...
		<Button className={styles.faqContent} kind="ButtonRotate">
			...
			{/* <div className={styles.container}>
				...
				<div className={styles.o}>
					<h5>HOW MUCH?</h5>
					<p>Each genesis land NFT will be priced at 0.12eth + gas fees.</p>
				</div>
				<div className={styles.c}>d</div>
				<div className={styles.v}>d</div>
				<div className={styles.h}>d</div>
				<div className={styles.p}>d</div>
				<div className={styles.g}>d</div>
				<div className={styles.j}>f</div>
				<div className={styles.k}>f</div>
				<div className={styles.l}>f</div>
			</div> */}
			<div className={styles.faqContentLeft}>
				...
				<div className={styles.faqContentLeftImages}>
					<svg xmlns="http://www.w3.org/2000/svg" width="56" height="25" viewBox="0 0 56 25" fill="none">
						<path d="M1.3335 21.3785L19.1562 3.55579V21.3785L36.979 3.55579V21.3785L54.8017 3.55579V21.3785" stroke="white" stroke-width="2.28497" />
					</svg>
					...
					<div><svg xmlns="http://www.w3.org/2000/svg" width="84" height="20" viewBox="0 0 84 20" fill="none">
					...
					<div className={styles.faqContentCenterImagesEllipse}>
						<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
							<g clip-path="url(#clip0_0_695)">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M0.435091 18.585L18.2578 36.5273L36.0806 18.585L18.4954 18.585L36.0806 0.881866L0.435092 0.881863L18.0203 18.585L0.435091 18.585Z" fill="white" />
							</g>
							<defs>
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
							<g clip-path="url(#clip0_0_698)">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M22.2638 0.881836H15.1347V10.099L8.61715 3.58148L3.57611 8.6225L10.0936 15.14H0.876465V22.2691H10.0936L3.57611 28.7865L8.61715 33.8277L15.1347 27.3101V36.5273H22.2638V27.3101L28.7813 33.8277L33.8223 28.7867L27.3047 22.2691H36.5219V15.14H27.3047L33.8223 8.6225L28.7813 3.58146L22.2638 10.099V0.881836Z" fill="white" />
							</g>
							<defs>
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="35" height="36" viewBox="0 0 35 36" fill="none">
							<g clip-path="url(#clip0_0_696)">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M17.4809 35.5274L34.9631 18.1616L17.4809 0.795898L17.4809 17.9301L0.231644 0.795897L0.231642 35.5274L17.4809 18.3931L17.4809 35.5274Z" fill="white" />
							</g>
							<defs>
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
							<g clip-path="url(#clip0_0_697)">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M35.4046 18.2782L18.0388 0.795901L0.673093 18.2782L17.8073 18.2782L0.67309 35.5274L35.4046 35.5274L18.2703 18.2782L35.4046 18.2782Z" fill="white" />
							</g>
							<defs>
