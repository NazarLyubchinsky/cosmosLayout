	...
	return (
		<Button kind="ButtonRotate" className={styles.faqContent}>
			<div className={styles.faqContentLeft} >
				<div className={styles.faqContentLeftTop} data-aos="zoom-in">
				...
				<div className={styles.faqContentLeftImages} data-aos="zoom-in">
				...
				<div className={styles.faqContentLeftCenter} data-aos="zoom-in">
				...
				<div className={styles.faqContentLeftBottom} data-aos="zoom-in">
			...
			<div className={styles.faqContentCenter}>
				<div className={styles.faqContentCenterTop} data-aos="zoom-in">
					<p className={styles.title}>How many?</p>
					<span className={styles.subtitle}>Our genesis land NFT collection will comprise </span>
				</div>

				<div className={styles.faqContentCenterImages} data-aos="zoom-in">
					...
					<div className={styles.faqContentCenterImagesEllipse} data-aos="zoom-in">
				...
				<div className={styles.faqContentCenterCenter} data-aos="zoom-in">
					<h5 className={styles.title}>WHEN mint?</h5>
					<p className={styles.subtitle}>We are targeting a release in mid May.</p>
				</div>
				<div className={styles.faqContentCenterBottom} data-aos="zoom-in">
			...
			<div className={styles.faqContentRight}>
				<div className={styles.faqContentRightTop} data-aos="zoom-in">
				...
				<div className={styles.faqContentRightCenter} data-aos="zoom-in">
				...
				<div className={styles.faqContentRightBottom} data-aos="zoom-in">
